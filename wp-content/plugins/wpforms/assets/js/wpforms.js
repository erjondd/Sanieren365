					...
					if (typeof window['wpforms_' + formID] !== 'undefined' && window['wpforms_' + formID].hasOwnProperty('validate')) {
						...
						properties = {
							...
							highlight: function (element, errorClass, validClass) {
								...
								jQuery("div.wpforms-container-full .wpforms-form .wpforms-page-1 .wpforms-pagebreak-left .wpforms-page-button").removeClass("blue-button");
								jQuery("div.wpforms-container-full .wpforms-form .wpforms-page-2 .wpforms-pagebreak-left .wpforms-page-button").removeClass("blue-button");
								jQuery("div.wpforms-container-full .wpforms-form .wpforms-page-3 .wpforms-pagebreak-left .wpforms-page-button").removeClass("blue-button");
								jQuery("div.wpforms-container-full .wpforms-form .wpforms-page-4 .wpforms-pagebreak-left .wpforms-page-button").removeClass("blue-button");
								jQuery("div.wpforms-container-full .wpforms-form .wpforms-page-5 .wpforms-pagebreak-left .wpforms-page-button").removeClass("blue-button");
								jQuery("div.wpforms-container-full .wpforms-form .wpforms-page-6 .wpforms-pagebreak-left .wpforms-page-button").removeClass("blue-button");
								jQuery("div.wpforms-container-full .wpforms-form .wpforms-page-7 .wpforms-pagebreak-left .wpforms-page-button").removeClass("blue-button");
							},
				...
				switch ($this.attr('type')) {
					case 'radio':
						...
						$this
							...
							jQuery("div.wpforms-container-full .wpforms-form .wpforms-pagebreak-left .wpforms-page-button").addClass("blue-button");
						break;
